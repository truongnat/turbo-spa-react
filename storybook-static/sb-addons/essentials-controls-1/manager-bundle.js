try {
  ...
  var nh = F((fX, rh) => {
    ...
    rh.exports = function () {
      return (
        { __proto__: th }.foo === th.foo && !({ __proto__: null } instanceof GB)
      );
    };
  });
  var oh = F((yX, ah) => {
    ...
    ah.exports = function (t) {
      var r = this;
      if (typeof r != 'function' || VB.call(r) !== KB)
  ...
  var Hh = F((WX, zh) => {
    ...
    function IT(e) {
      ...
      return r
        ? '\\' + r
        : '\\x' + (t < 16 ? '0' : '') + yT.call(t.toString(16));
    }
    function kr(e) {
      return 'Object(' + e + ')';
    }
  ...
  var nr,
    ...
    am = Xe(() => {
      ...
      (VO = typeof window < 'u' ? yi : me),
        (KO = function () {
          return (
            WO || (typeof __webpack_nonce__ < 'u' ? __webpack_nonce__ : void 0)
          );
        }),
        (Hg = new Map()),
        (Zg = function (e) {
      ...
      if ((t && typeof t == 'object') || typeof t == 'function')
        for (let a of pg(t))
          !$8.call(e, a) &&
            ...
            cg(e, a, {
              get: () => t[a],
              enumerable: !(n = q8(t, a)) || n.enumerable,
            });
      return e;
    },
    Qn = (e, t, r) => (
