declare namespace JsonSchemaOrg {
  namespace Draft04 {
    ...
    export interface Schema {
      ...
      items?: /* Core schema meta-schema */
      Schema | Schema.Definitions.SchemaArray;
      ...
      dependencies?: {
        [name: string]: /* Core schema meta-schema */
        Schema | Schema.Definitions.StringArray;
      };
      enum?: any[];
      type?:
        | Schema.Definitions.SimpleTypes
        | [Schema.Definitions.SimpleTypes, ...Schema.Definitions.SimpleTypes[]];
      format?: string;
    ...
    namespace Schema {
      ...
      namespace Properties {
        ...
        export type Type =
          ...
          | [Definitions.SimpleTypes, ...Definitions.SimpleTypes[]];
...
declare namespace SwaggerIo {
  namespace V2 {
    ...
    export interface SchemaJson {
      ...
      [
        pattern: string
      ]: /* Any property starting with x- is valid. */ SchemaJson.Definitions.VendorExtension /* Patterns: ^x- */;
    }
    namespace SchemaJson {
      namespace Definitions {
        export interface ApiKeySecurity {
          ...
          [
            pattern: string
          ]: /* Any property starting with x- is valid. */ VendorExtension /* Patterns: ^x- */;
        }
        ...
        export type ExclusiveMaximum =
          JsonSchemaOrg.Draft04.Schema.Properties.ExclusiveMaximum;
        export type ExclusiveMinimum =
          JsonSchemaOrg.Draft04.Schema.Properties.ExclusiveMinimum;
        /**
        ...
        export type MaxItems =
          JsonSchemaOrg.Draft04.Schema.Definitions.PositiveInteger;
        ...
        export type MinItems =
          JsonSchemaOrg.Draft04.Schema.Definitions.PositiveIntegerDefault0;
        export type MinLength =
          JsonSchemaOrg.Draft04.Schema.Definitions.PositiveIntegerDefault0;
        export type Minimum = JsonSchemaOrg.Draft04.Schema.Properties.Minimum;
        export type MultipleOf =
          JsonSchemaOrg.Draft04.Schema.Properties.MultipleOf;
        ...
        export interface Paths {
          [pattern: string]: /* Any property starting with x- is valid. */
          VendorExtension | PathItem /* Patterns: ^x- | ^/ */;
        }
        export type Pattern =
          JsonSchemaOrg.Draft04.Schema.Properties.Pattern /* regex */;
        ...
        export interface Responses {
          [pattern: string]:
            | ResponseValue
            | /* Any property starting with x- is valid. */ VendorExtension /* Patterns: ^([0-9]{3})$|^(default)$ | ^x- */;
        }
        /**
         * A deterministic version of a JSON Schema object.
         */
        ...
        export type UniqueItems =
          JsonSchemaOrg.Draft04.Schema.Properties.UniqueItems;
        /**
